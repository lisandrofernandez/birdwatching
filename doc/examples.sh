...
curl -v -X PUT -H 'Content-Type: application/json' -d '{"name": "Central Park", "regionId": 1}' localhost:8080/api/v1/reserves/2 | jq '.'
# delete natural reserve
curl -v -X DELETE localhost:8080/api/v1/reserves/2 | jq '.'
